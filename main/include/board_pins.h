...
#define BOARD_DEVKITC_ESP32_V2
// #define BOARD_DEVKITC_ESP32S3_V1
// #define BOARD_SUPERMINI_ESP32C3_V1
// #define BOARD_HELTEC_WIRELESS_STICK_LITE_ESP32S3_V3

#ifdef CONFIG_IDF_TARGET_ESP32
    #if defined(BOARD_DEVKITC_ESP32_V2)
    ...
    // Not Tested
    #elif defined(BOARD_HELTEC_WIRELESS_STICK_LITE_ESP32S3_V3)
        #define ANEMOMETER_ADC_PIN GPIO_NUM_3
